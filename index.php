...
<body>
	...
	<form  method="post" onSubmit='Login.php'>
		...
		<div style="position:absolute;left:81.8%;top:5.2%; ">   <input type="submit" name="Login" class="button"  value="Log In" id="login_button" />  </div>
	</form>
    ...
    <div style="position:absolute; left:7%; top:24%; color:#3B5998; font-size:28px;"> <font face="myFbFont"> Younzs helps you connect and share with </font> </div>
	...
	<!-- Registration -->
	<form  method="post"  name="Reg" onSubmit='fb_files/fb_index_file/fb_SignUp_file/SignUp.php'>
		...
		<div style="position:absolute;left:65.2%;   top:32.8%; "> <input type="text"  name="first_name" title="enter" class="inputbox" maxlength="10"/> </div>
